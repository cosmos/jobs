...
jQuery( function( $ ) {
    ...
    var $portfolio_images    = $( '#portfolio_images_container' ).find( 'ul.portfolio_images' );
    ...
    $portfolio_images.sortable({
        ...
        helper: 'clone',
        opacity: 0.65,
        placeholder: 'front-metabox-sortable-placeholder',
        ...
        update: function() {
            ...
            $( '#portfolio_images_container' ).find( 'ul li.image' ).css( 'cursor', 'default' ).each( function() {
