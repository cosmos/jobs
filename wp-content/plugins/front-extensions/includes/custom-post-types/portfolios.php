...
if ( ! class_exists( 'Front_Jetpack_Portfolio' ) ):
class Front_Jetpack_Portfolio {
	...
	static function init() {
		...
		if ( ! $instance ) {
			$instance = new Front_Jetpack_Portfolio;
		}
	...
	function __construct() {
		...
		$enable_portfolio = apply_filters( 'front_extensions_enable_portfolio', true );
	...
	function settings_api_init() {
		add_settings_field(
			self::OPTION_NAME,
			'<span class="cpt-options">' . __( 'Portfolio Projects', 'front-extensions' ) . '</span>',
	...
	function setting_html() {
		if ( current_theme_supports( self::CUSTOM_POST_TYPE ) ) : ?>
			<p><?php printf( /* translators: %s is the name of a custom post type such as "jetpack-portfolio" */ __( 'Your theme supports <strong>%s</strong>', 'front-extensions' ), self::CUSTOM_POST_TYPE ); ?></p>
		<?php else : ?>
			<label for="<?php echo esc_attr( self::OPTION_NAME ); ?>">
				<input name="<?php echo esc_attr( self::OPTION_NAME ); ?>" id="<?php echo esc_attr( self::OPTION_NAME ); ?>" <?php echo checked( get_option( self::OPTION_NAME, '0' ), true, false ); ?> type="checkbox" value="1" />
				<?php esc_html_e( 'Enable Portfolio Projects for this site.', 'front-extensions' ); ?>
				<a target="_blank" href="https://en.support.wordpress.com/portfolios/"><?php esc_html_e( 'Learn More', 'front-extensions' ); ?></a>
			</label>
		<?php endif;
		if ( get_option( self::OPTION_NAME, '0' ) || current_theme_supports( self::CUSTOM_POST_TYPE ) ) :
			printf( '<p><label for="%1$s">%2$s</label></p>',
				...
				sprintf( __( 'Portfolio pages display at most %1$s projects', 'front-extensions' ),
	...
	*/
	...
	function register_post_types() {
		...
		register_post_type( self::CUSTOM_POST_TYPE, array(
			'labels' => array(
				'name'                  => esc_html__( 'Projects',                   'front-extensions' ),
				'singular_name'         => esc_html__( 'Project',                    'front-extensions' ),
				'menu_name'             => esc_html__( 'Portfolio',                  'front-extensions' ),
				'all_items'             => esc_html__( 'All Projects',               'front-extensions' ),
				'add_new'               => esc_html__( 'Add New',                    'front-extensions' ),
				'add_new_item'          => esc_html__( 'Add New Project',            'front-extensions' ),
				'edit_item'             => esc_html__( 'Edit Project',               'front-extensions' ),
				'new_item'              => esc_html__( 'New Project',                'front-extensions' ),
				'view_item'             => esc_html__( 'View Project',               'front-extensions' ),
				'search_items'          => esc_html__( 'Search Projects',            'front-extensions' ),
				'not_found'             => esc_html__( 'No Projects found',          'front-extensions' ),
				'not_found_in_trash'    => esc_html__( 'No Projects found in Trash', 'front-extensions' ),
				'filter_items_list'     => esc_html__( 'Filter projects list',       'front-extensions' ),
				'items_list_navigation' => esc_html__( 'Project list navigation',    'front-extensions' ),
				'items_list'            => esc_html__( 'Projects list',              'front-extensions' ),
			),
			'supports' => array(
				'title',
				'editor',
		...
		register_taxonomy( self::CUSTOM_TAXONOMY_TYPE, self::CUSTOM_POST_TYPE, array(
			'hierarchical'      => true,
			'labels'            => array(
				'name'                  => esc_html__( 'Project Types',                 'front-extensions' ),
				'singular_name'         => esc_html__( 'Project Type',                  'front-extensions' ),
				'menu_name'             => esc_html__( 'Project Types',                 'front-extensions' ),
				'all_items'             => esc_html__( 'All Project Types',             'front-extensions' ),
				'edit_item'             => esc_html__( 'Edit Project Type',             'front-extensions' ),
				'view_item'             => esc_html__( 'View Project Type',             'front-extensions' ),
				'update_item'           => esc_html__( 'Update Project Type',           'front-extensions' ),
				'add_new_item'          => esc_html__( 'Add New Project Type',          'front-extensions' ),
				'new_item_name'         => esc_html__( 'New Project Type Name',         'front-extensions' ),
				'parent_item'           => esc_html__( 'Parent Project Type',           'front-extensions' ),
				'parent_item_colon'     => esc_html__( 'Parent Project Type:',          'front-extensions' ),
				'search_items'          => esc_html__( 'Search Project Types',          'front-extensions' ),
				'items_list_navigation' => esc_html__( 'Project type list navigation',  'front-extensions' ),
				'items_list'            => esc_html__( 'Project type list',             'front-extensions' ),
			),
			'public'            => true,
			'show_ui'           => true,
		...
		register_taxonomy( self::CUSTOM_TAXONOMY_TAG, self::CUSTOM_POST_TYPE, array(
			'hierarchical'      => false,
			'labels'            => array(
				'name'                       => esc_html__( 'Project Tags',                   'front-extensions' ),
				'singular_name'              => esc_html__( 'Project Tag',                    'front-extensions' ),
				'menu_name'                  => esc_html__( 'Project Tags',                   'front-extensions' ),
				'all_items'                  => esc_html__( 'All Project Tags',               'front-extensions' ),
				'edit_item'                  => esc_html__( 'Edit Project Tag',               'front-extensions' ),
				'view_item'                  => esc_html__( 'View Project Tag',               'front-extensions' ),
				'update_item'                => esc_html__( 'Update Project Tag',             'front-extensions' ),
				'add_new_item'               => esc_html__( 'Add New Project Tag',            'front-extensions' ),
				'new_item_name'              => esc_html__( 'New Project Tag Name',           'front-extensions' ),
				'search_items'               => esc_html__( 'Search Project Tags',            'front-extensions' ),
				'popular_items'              => esc_html__( 'Popular Project Tags',           'front-extensions' ),
				'separate_items_with_commas' => esc_html__( 'Separate tags with commas',      'front-extensions' ),
				'add_or_remove_items'        => esc_html__( 'Add or remove tags',             'front-extensions' ),
				'choose_from_most_used'      => esc_html__( 'Choose from the most used tags', 'front-extensions' ),
				'not_found'                  => esc_html__( 'No tags found.',                 'front-extensions' ),
				'items_list_navigation'      => esc_html__( 'Project tag list navigation',    'front-extensions' ),
				'items_list'                 => esc_html__( 'Project tag list',               'front-extensions' ),
			),
			'public'            => true,
			'show_ui'           => true,
			'show_in_nav_menus' => true,
	...
	function updated_messages( $messages ) {
		...
		$messages[self::CUSTOM_POST_TYPE] = array(
			...
			1  => sprintf( __( 'Project updated. <a href="%s">View item</a>', 'front-extensions'), esc_url( get_permalink( $post->ID ) ) ),
			2  => esc_html__( 'Custom field updated.', 'front-extensions' ),
			3  => esc_html__( 'Custom field deleted.', 'front-extensions' ),
			4  => esc_html__( 'Project updated.', 'front-extensions' ),
			/* translators: %s: date and time of the revision */
			5  => isset( $_GET['revision'] ) ? sprintf( esc_html__( 'Project restored to revision from %s', 'front-extensions'), wp_post_revision_title( (int) $_GET['revision'], false ) ) : false,
			6  => sprintf( __( 'Project published. <a href="%s">View project</a>', 'front-extensions' ), esc_url( get_permalink( $post->ID ) ) ),
			7  => esc_html__( 'Project saved.', 'front-extensions' ),
			8  => sprintf( __( 'Project submitted. <a target="_blank" href="%s">Preview project</a>', 'front-extensions'), esc_url( add_query_arg( 'preview', 'true', get_permalink( $post->ID ) ) ) ),
			9  => sprintf( __( 'Project scheduled for: <strong>%1$s</strong>. <a target="_blank" href="%2$s">Preview project</a>', 'front-extensions' ),
			// translators: Publish box date format, see https://php.net/date
			date_i18n( __( 'M j, Y @ G:i', 'front-extensions' ), strtotime( $post->post_date ) ), esc_url( get_permalink( $post->ID ) ) ),
			10 => sprintf( __( 'Project item draft updated. <a target="_blank" href="%s">Preview project</a>', 'front-extensions' ), esc_url( add_query_arg( 'preview', 'true', get_permalink( $post->ID ) ) ) ),
		);
	...
	function edit_admin_columns( $columns ) {
		...
		$columns['title'] = __( 'Project', 'front-extensions' );
	...
	function customize_register( $wp_customize ) {
		...
		$wp_customize->add_section( 'jetpack_portfolio', array(
			'title'                    => esc_html__( 'Portfolio', 'front-extensions' ),
		...
		if ( isset( $options[0]['title'] ) && true === $options[0]['title'] ) {
			$wp_customize->add_setting( 'jetpack_portfolio_title', array(
				'default'              => esc_html__( 'Projects', 'front-extensions' ),
				'type'                 => 'option',
			...
			$wp_customize->add_control( 'jetpack_portfolio_title', array(
				...
				'label'                => esc_html__( 'Portfolio Archive Title', 'front-extensions' ),
				'type'                 => 'text',
			) );
		}
		...
		if ( isset( $options[0]['content'] ) && true === $options[0]['content'] ) {
			...
			$wp_customize->add_control( 'jetpack_portfolio_content', array(
				'section'              => 'jetpack_portfolio',
				'label'                => esc_html__( 'Portfolio Archive Content', 'front-extensions' ),
				'type'                 => 'textarea',
			) );
		}
		...
		if ( isset( $options[0]['featured-image'] ) && true === $options[0]['featured-image'] ) {
			...
			$wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'jetpack_portfolio_featured_image', array(
				'section'              => 'jetpack_portfolio',
				'label'                => esc_html__( 'Portfolio Archive Featured Image', 'front-extensions' ),
			) ) );
		}
	}
	...
	static function portfolio_shortcode_html( $atts ) {
		...
		<?php
			...
			<p><em><?php _e( 'Your Portfolio Archive currently has no entries. You can start creating them on your dashboard.', 'front-extensions' ); ?></p></em>
		<?php
		}
		$html = ob_get_clean();
	...
	static function get_project_type( $post_id ) {
		...
		$html = '<div class="project-types"><span>' . __( 'Types', 'front-extensions' ) . ':</span>';
		$types = array();
	...
	static function get_project_tags( $post_id ) {
		...
		$html = '<div class="project-tags"><span>' . __( 'Tags', 'front-extensions' ) . ':</span>';
		$tags = array();
	...
	static function get_project_author() {
		...
		$html .= sprintf( __( '<span>Author:</span> <a href="%1$s">%2$s</a>', 'front-extensions' ),
...
add_action( 'init', array( 'Front_Jetpack_Portfolio', 'init' ) );

// Check on plugin activation if theme supports CPT
register_activation_hook( __FILE__,                         array( 'Front_Jetpack_Portfolio', 'activation_post_type_support' ) );
add_action( 'jetpack_activate_module_custom-content-types', array( 'Front_Jetpack_Portfolio', 'activation_post_type_support' ) );
