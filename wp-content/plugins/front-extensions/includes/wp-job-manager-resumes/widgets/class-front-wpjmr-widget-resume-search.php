 ...
 *
 * @class       Front_WPJMR_Widget_Resume_Search
 * @version     1.0.0
 * @package     Widgets
 * @category    Class
 * @author      MadrasThemes
...
if( class_exists( 'WP_Widget' ) ) :
     ...
     * @since 1.0.0
     */
    class Front_WPJMR_Widget_Resume_Search extends WP_Widget {

        public function __construct() {
            $widget_ops = array( 'description' => esc_html__( 'Add resume search widgets to your sidebar.', 'front-extensions' ) );
            parent::__construct( 'front_wpjmr_search', esc_html__( 'Front Resume Search', 'front-extensions' ), $widget_ops );
        }

        public function widget($args, $instance) {

            $instance['title'] = apply_filters( 'front_wpjmr_search_widget_title', empty( $instance['title'] ) ? '' : $instance['title'], $instance, $this->id_base );
            ...
            ?>
            <form method="get" class="front-wpjmr-search" action="<?php echo esc_url( $link ); ?>">
