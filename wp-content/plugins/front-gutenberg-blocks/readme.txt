...
FrontGB is a collection of beautiful ready-to-use custom blocks that builds on and supercharges the new WordPress block editor (Gutenberg). FrontGB’s blocks give you the capability to easily create great websites with just a few clicks.

Visit our [website](https://wpstackable.com) (made with Gutenberg + FrontGB blocks) to learn more about FrontGB.

FrontGB provides feature-rich blocks that gives you more design options for your site. FrontGB’s blocks look great out of the box, and will make website building a breeze.

FrontGB’s custom blocks come with multiple block layouts that you can use to build your perfect site without writing a single line of code. FrontGB blocks are also responsive and will look great even in small screens.
...
## FrontGB Effects & Features

FrontGB also comes with **great effects and features**. Enjoy different background options - image or video backgrounds, fixed images, single and gradient tinted background effects. You can also make use of different image box hover effects to add a little something extra to your pages.

Check out the FrontGB demos to see what FrontGB can do.

## FrontGB WordPress Theme

Get our WordPress theme that's beautiful & flexible, Gutenberg-ready and made especially for FrontGB blocks and the new WordPress editor. [Download the FrontGB Theme now](http://eepurl.com/dJY9xI).

## FrontGB Premium

FrontGB Premium extends the capabilities of FrontGB and the new WordPress editor to give you the smoothest page building experience. Using the core FrontGB Philosophy of balancing utility and great design, FrontGB Premium offers premium design layouts and effects, premium functionality and focused one-on-one customer care.

While you can create great pages with FrontGB, FrontGB Premium lets you do so much more.

Try out a [live demo of FrontGB Premium](https://demo.wpstackable.com/blog-posts/)
...
- [v1.13 Introducing FrontGB Premium](https://wpstackable.com/blog/introducing-stackable-premium/)
- [v1.12 FrontGB Is Now in GitHub](https://wpstackable.com/blog/stackable-is-now-in-github/)
...
### Learn More About FrontGB - Gutenberg Blocks

- [Twitter @wpstackable](https://twitter.com/wpstackable)
- [Facebook Page WPFrontGB](https://www.facebook.com/FrontGB-870555573068267/)
- [What is FrontGB?](https://wpstackable.com/blog/welcome-to-stackable/)
...
With WordPress 5.0 & Gutenberg, you build your pages using *blocks*, and FrontGB provides you with lots of cool ones.
...
FrontGB gives you lots of awesome blocks for you to create awesome landing pages and front pages.

**Can I use this with other block plugins?**

Yes! FrontGB blocks play well with other blocks.

**Can I use this add-on for other page builders I’m using?**

Nope. FrontGB only works with Gutenberg, the new WordPress editor.
...
= 1.13.0 =
[Introducing FrontGB Premium](https://wpstackable.com/blog/introducing-stackable-premium/)

* New: Added FrontGB Premium pricing page
...
* Fixed: Smooth transitions for FrontGB blocks no longer affect non-block elements during editing
...
* New: Added notifications for the FrontGB welcome screen.
...
= 1.1.1 =
* New: Added default color / primary color support for future FrontGB theme
...
= 0.6 =
* New: Grouped together all FrontGB blocks
...
* New: Pricing Block
* New: Header Block
* Fixed: FrontGB block icons did not show in Gutenberg 2.6.0
