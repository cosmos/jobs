...
if ( is_user_logged_in() ) : ?>
	...
	<fieldset>
		...
		<div class="field account-sign-in">
			<a class="button btn btn-primary mr-5 mb-5 float-left" href="<?php echo apply_filters( 'submit_resume_form_login_url', wp_login_url( add_query_arg( [ 'job_id' => $class->get_job_id() ], get_permalink() ) ) ); ?>"><?php _e( 'Sign in', 'wp-job-manager-resumes' ); ?></a>
