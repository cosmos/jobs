   ...
   <!--  <a class="card card-frame mb-3" href="<?php echo esc_url(wc_get_endpoint_url( 'edit-address'));?>">
        <div class="card-body p-5">
            <div class="media align-items-center">
                ...
                <div class="media-body">
                    <h5 class="d-block text-dark mb-0"><?php esc_html_e( 'This page can be changed', 'front' ); ?></h5>
                    <small class="d-block text-secondary"><?php esc_html_e( 'front_child/woocommerce/myaccount/dashboard.php', 'front' ); ?></small>
                </div>
            </div>
        </div>
    </a> -->
