...
function cosmos_customize_submit_project_form_fields( $fields ) {
  ...
  $fields['company_fields']['company_video']['type'] = "url";
  ...
  $fields['company_fields']['company_website']['placeholder'] = "Project Website";
  $fields['company_fields']['company_website']['type'] = "url";
  $fields['company_fields']['company_twitter']['type'] = "url";
  $fields['company_fields']['company_facebook']['type'] = "url";
  $fields['company_fields']['company_github']['type'] = "url";
  $fields['company_fields']['company_documentation']['type'] = "url";
  $fields['company_fields']['company_medium']['type'] = "url";
  ...
  $fields['company_fields']['company_email']['type'] = 'email';
