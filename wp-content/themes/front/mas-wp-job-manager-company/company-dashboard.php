...
<div id="job-manager-company-dashboard" class="table-responsive-md">
    <p><?php echo esc_html( _n( 'Your company can be viewed, edited or removed below.', 'Your companies can be viewed, edited or removed below.', mas_wpjmc_company_manager_count_user_companies(), 'front' ) ); ?></p>
            ...
            <tfoot>
                <tr>
                    <td colspan="<?php echo sizeof( $company_dashboard_columns ); ?>">
                        <a class="btn btn-sm btn-primary" href="<?php echo esc_url( get_permalink( $submit_company_form_page_id ) ); ?>"><?php esc_html_e( 'Add Company', 'front' ); ?></a>
                    </td>
                </tr>
            </tfoot>
        <?php endif; ?>
